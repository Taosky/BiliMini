<template>
  <div>
    <!-- type:8 普通视频 -->
    <div class="card" v-if="cardObj._type === 8">
    ...
    <!-- type:512 番剧 -->
    <div class="card" v-else-if="cardObj._type === 512">
    ...
    <!-- type:4099 综艺-->
    <div class="card" v-else-if="cardObj._type === 4099">
      <a class="video-img" :href="cardObj.url"
        ><img class="cover" :src="cardObj.cover" alt="tumb" style="width: 100%"
      /></a>
      <span class="type-name-b">{{ cardObj.apiSeasonInfo.type_name }}</span>
      <span class="pub-time">{{ cardObj.retime }}</span>
      <div class="container">
        <a style="text-decoration: none; color: black" :href="cardObj.url">
          <h5 class="title">
